...
<i class="fas fa-chevron-right"></i>
<span class="breadcrumb-item active">Novo Professor</span>
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-dark">Novo Professor</h2>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('subjects') is-invalid @enderror" id="subjects" name="subjects[]" multiple>
                                        @foreach($specialties as $specialty)
                                            <option value="{{ $specialty }}" {{ in_array($specialty, old('subjects', [])) ? 'selected' : '' }}>
                                                {{ $specialty }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('observations') is-invalid @enderror"
                                              ...
                                              name="observations"
                                              rows="3"
                                              placeholder="Informações adicionais sobre o professor...">{{ old('observations') }}</textarea>
                                    @error('observations')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
